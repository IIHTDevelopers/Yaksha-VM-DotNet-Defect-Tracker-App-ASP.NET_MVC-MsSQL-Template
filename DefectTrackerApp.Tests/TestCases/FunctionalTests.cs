...
namespace DefectTrackerApp.Tests.TestCases
{
    public class FunctionalTests
    {
        ...
        [Fact]
        public async Task<bool> Testfor_Get_Defect()
        {
            //Arrange
            var res = false;
        ...
        [Fact]
        public async Task<bool> Testfor_Get_Defect_ById()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_Update_Defect()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_Delete_Defect()
        {
            //Arrange
            var res = false;
            string testName; string status;
            ...
            try
            {
                defecttrackerservice.Setup(repos => repos.DeleteDefect(_Defect.Id)).Returns(1);
